...
pixi add drjit drjit-cpp
# for installing globally
pixi global install drjit drjit-cpp
```
...
It is possible to list all of the versions of `drjit` available on your platform:
...
```
pixi search drjit --channel conda-forge
```
